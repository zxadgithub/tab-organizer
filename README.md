...
- Manager page: grouped view, collapse or expand, pin domain, focus tab, drag reorder, multi-close, group close, and undo close.
...
- 管理页操作：按域名分组查看、折叠或展开、置顶域名、跳转标签页、拖拽排序、多选关闭、整组关闭、撤销关闭。
